...
public class AnimationUtil {
     ...
     * @param view
     */
    public static AnimatorSet startScaleToBigAnimation(final View view, float rate, Animator.AnimatorListener animatorListener) {
    ...
    public static AnimatorSet startScaleToBigAnimation(final View view, float rate, Animator.AnimatorListener animatorListener , long duration) {
        if (null != view.getAnimation()) {
     ...
     * @param view
     */
    public static AnimatorSet startScaleToSmallAnimation(View view, float rate, Animator.AnimatorListener animatorListener) {
        if (null != view.getAnimation()) {
            view.getAnimation().cancel();
        }
        view.clearAnimation();
    ...
    public static AnimatorSet startScaleToSmallAnimation(View view, float rate, Animator.AnimatorListener animatorListener, long duration) {
        if (null != view.getAnimation()) {
            view.getAnimation().cancel();
        }
        view.clearAnimation();
